---
layout: post
title: "The Path to STAC 1.0.0"
date: 2021-02-18
source: medium
source_name: "Radiant Earth Insights (Medium)"
source_url: https://medium.com/radiant-earth-insights/the-path-to-stac-1-0-0-6bedc0f644d
image: /assets/img/posts/the-path-to-stac-1-0-0/1_4WiBDbx3hpGTMeWVu_V_yg.png
---

![](/assets/img/posts/the-path-to-stac-1-0-0/1_4WiBDbx3hpGTMeWVu_V_yg.png)

It’s almost time! The [SpatioTemporal Asset Catalog](http://stacspec.org) (STAC) specification has been maturing for over 3 years, and already has a rich ecosystem of tools with hundreds of millions of assets cataloged. The core community has agreed that it’s time to put a pin on it and lock in a super stable specification that can be a core building block for years to come. We believe STAC will be the foundation of something truly special: A transformation to a ‘Cloud Native Geospatial’ world that will open up unimaginable innovation.
...
![](/assets/img/posts/the-path-to-stac-1-0-0/1_2e5Wn6sdyYoRFe4vjzrsyQ.png)

*STAC [Ecosystem Roadmap](https://github.com/stac-utils/stac-ecosystem)*

**Post 1.0.0**: After the 1.0.0 release and the coordinated push on the ecosystem tools, the community’s attention will turn to building the ecosystem and getting as much data as possible into STAC catalogs. For the ecosystem, we’ve put together a [roadmap](https://github.com/stac-utils/stac-ecosystem) of all the tools that bring the core of the vision to reality. Converting more data into STAC will require a large outreach effort, with sprints focused on converting data and building an even richer ecosystem of tool support.

### Forming a Project Steering Committee

The other thing we are doing as part of the 1.0.0 release process is to formally recognize that STAC has transitioned from a ‘[Benevolent Dictator](https://en.wikipedia.org/wiki/Benevolent_dictator_for_life)’ model to a robust community. We will be creating a formal ‘Project Steering Committee’ to govern decisions about the specification. This has always been a [goal of mine](https://github.com/radiantearth/stac-spec/blob/master/process.md#governance) with STAC, so while I’ve enjoyed my reign as a dictator, I look forward to abdicating to formal democracy. Just about everything in the day-to-day of the project will remain the same. However, if there are contentious decisions, there will be a body we can rely upon that brings the diverse perspectives of the key contributors of the community. This group will also control decisions about where to spend any sponsorship funding.
...
**Sign up** on [**this form](https://forms.gle/9f2ZzcHUqpBA1qYe7)** to be notified of the details if you’re interested in joining us.

## Sponsorship

If your organization is interested in sponsoring STAC, now is the time to do so. For this sprint, we don’t have that many expenses. But our goal is to gather money for deposit in the [Radiant Earth Foundation](http://radiant.earth) STAC account to support the newly forming Project Steering Committee work directing the key ecosystem needs. You can read more details in the [sponsorship prospectus](https://docs.google.com/document/d/19kKkMVa3ZE3BQDu2UsKlo0aN5TMsZTvU-JZ257eyvIc/edit#), which includes information on how to submit funds. We’ll be promoting the sponsors, and you’ll be able to say that your organization truly made STAC 1.0 happen.
