...
source_url: https://cloudnativegeo.org/blog/2024/04/common-schemas-and-ids/
---
...
Because publishing cloud-native data is as simple as uploading files to a commodity cloud object service[2](#fn:2), it is now easier for data publishers to collaborate and experiment with new schemas. This ease of experimentation was a major contributor to the development and adoption of STAC. Contrast this with the state of numerous open data portals today that require rigid data models and are designed in ways that discourage experimentation at the schema level.
...
![Screenshot of ChatGPT responding to the question: How many buildings are there in San Francisco](/assets/img/posts/the-importance-of-common-data-schemas-and-identifiers/20240222-ids-1.png)
...
![](/assets/img/posts/the-importance-of-common-data-schemas-and-identifiers/20240222-ids-2.png)
...
This general pattern should work for any common type of data and creates opportunities to improve the usability of data for climate use cases. We can imagine common schemas used to describe land parcels, pollution, trees, demographics, waterways, ports, etc.[3](#fn:3)
...
![Screenshot of the Varda Global FieldID website](/assets/img/posts/the-importance-of-common-data-schemas-and-identifiers/20240222-ids-4.png)

Varda’s [Global FieldID](https://www.varda.ag/global-field-id)
...
![Screenshot a map showing farm fields delineated by Varda](/assets/img/posts/the-importance-of-common-data-schemas-and-identifiers/20240222-ids-3.png)

Screenshot taken from Varda’s [Global FieldID](https://fieldid.varda.ag) service showing field boundaries and their identifiers in southern Brazil.
...
If you know of any good examples of common data schemas or groups working on creating common identifiers, we’d love to hear about them. Please write to us at [hello@cloudnativegeo.org](mailto:hello@cloudnativegeo.org).
...
1. This is not to say we believe the existing formats will live forever – we welcome more innovation in cloud-native formats and will support members of our community as they explore new formats. [↩︎](#fnref:1)
2. And we’re working hard to make hosting data in the cloud as easy as possible through [Source Cooperative](https://source.coop). [↩︎](#fnref:2)
3. We want to reiterate that we know none of this will be simple (n.b. these two great papers: [When is a forest a forest?](https://link.springer.com/article/10.1007/s13280-016-0772-y) and [When is a forest not a forest?](https://academic.oup.com/jof/article/100/8/21/4608650)), but we believe it is *possible*. [↩︎](#fnref:3)
4. The Radiant Earth post [Unicorns, Show Ponies, and Gazelles](https://radiant.earth/blog/2024/01/unicorns-show-ponies-and-gazelles/) argues that we need to create new kinds of organizations that can create and manage global unique identifiers to make this vision a reality. [↩︎](#fnref:4)
