---
layout: post
title: "Building the GeoSpatial Web, Introduction"
date: 2006-06-11
source: wordpress
source_name: "cholmes.wordpress.com"
source_url: https://cholmes.wordpress.com/2006/06/11/building-the-geospatial-web-introduction/
tags: ["architectures of participation", "geospatial", "geospatial web"]
description: "Ok, it's finally time for me to get to the whole reason I started this blog, which I thought I'd have done in the first month or two. The thing I'd like to examine is how architectures of participation can apply to geospatial. I started a journal paper when I was in Africa, with the […]"
---

Ok, it's finally time for me to get to the whole reason I started this blog, which I thought I'd have done in the first month or two. The thing I'd like to examine is how [architectures of participation](https://cholmes.wordpress.com/2006/01/24/architectures-of-participation-yktm/) can apply to geospatial. I started a journal paper when I was in Africa, with the help of Mike Gould and Andreas Wytzisk. Unfortunately it was far too speculative for academia, and we've had a hard time turning it in to a real journal article, with appropriate references for everything. I learned a lot from their help, but as I have no immediate plans to be an academic, and more just want to try to see the ideas come in to being, I decided it makes sense to just present what I came up with in a blog so it's out, so the things I thought about my year in Zambia don't just live in my head.
