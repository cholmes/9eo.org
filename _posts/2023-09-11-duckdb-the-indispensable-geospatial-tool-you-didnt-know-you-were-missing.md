...
source_url: https://medium.com/radiant-earth-insights/duckdb-the-indispensable-geospatial-tool-you-didnt-know-you-were-missing-5fe11c5633e5
image: https://miro.medium.com/v2/resize:fit:1400/1*WifaTZmUls308x_BZ0We1A.png
also_at_name: "cloudnativegeo.org"
also_at_url: https://cloudnativegeo.org/blog/2023/09/duckdb-the-indispensable-geospatial-tool-you-didnt-know-you-were-missing/
---

(This post is also available at [https://cloudnativegeo.org/blog/2023/09/duckdb-the-indispensable-geospatial-tool-you-didnt-know-you-were-missing/](https://cloudnativegeo.org/blog/2023/09/duckdb-the-indispensable-geospatial-tool-you-didnt-know-you-were-missing/))
...
1. I did need the exact count to make sure I transformed every building properly.
...
![](/assets/img/posts/duckdb-the-indispensable-geospatial-tool-you-didnt-know-you-/1_g87NOfHtaRRCQRpZKENXbQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*0Wp1tacwMcZQxVUdnvpypg.gif)
...
![](/assets/img/posts/duckdb-the-indispensable-geospatial-tool-you-didnt-know-you-/1__iEp9524vc80C4aG_4TY0Q.gif)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*Rt6pQGXOkMrJz7FLKahn0Q.png)
...
DuckDB also has the ability to work in a completely ‘cloud native geospatial’ manner — you can treat remote files just like they’re on disk, and DuckDB will use range requests to optimize querying them. This is done with the awesome [httpfs extension](https://duckdb.org/docs/extensions/httpfs) , which makes it super easy to connect to remote data. It can point to any https file. The thing I really love is how easy it is to connect to S3 (or interfaces supporting S3, and I think native Azure support is coming soon).

`load httpfs;
 select * from ‘[https://data.source.coop/cholmes/overture/geoparquet-country-quad-2/BM.parquet';`](https://data.source.coop/cholmes/overture/geoparquet-country-quad-2/BM.parquet')
...
![](https://miro.medium.com/v2/resize:fit:1400/1*WifaTZmUls308x_BZ0We1A.png)

*Drivers supported in a typical DuckDB spatial instance*

This makes it super easy to get data into and out of DuckDB, and to also just use it as a processing engine instead of a full blown database where you need to store the data. Those deep in the spatial world will likely question why this is even necessary — why wouldn’t you just use GDAL itself to load and export data?
