...
source_url: https://medium.com/radiant-earth-insights/the-geoparquet-ecosystem-at-1-0-0-96dee8ce9201
image: /assets/img/posts/the-geoparquet-ecosystem-at-1-0-0/1_FgOatuSueWcC-cweyiJpDQ.png
also_at_name: "cloudnativegeo.org"
also_at_url: https://cloudnativegeo.org/blog/2023/10/the-geoparquet-ecosystem-at-1.0.0/
---
...
CARTO, my long-time favorite web-based analysis platform, added GeoParquet support recently. They’ve been one of the biggest supporters of GeoParquet, with [Alberto Asuero](https://github.com/alasarr) helping with core spec work and [Javier de la Torre](https://github.com/jatorre) leading lots of evangelizing of GeoParquet. You can easily import GeoParquet, and they’re starting to support export as well.
...
*The ideal Cloud-Native analytical geospatial vector file format Kyle Barron April 2022 Edits September 7, 2022: Updated…*observablehq.com](https://observablehq.com/@kylebarron/geoparquet-on-the-web)

[**GeoArrow and GeoParquet in deck.gl**
*Easier rendering of large geospatial data Kyle Barron August 11, 2022 As I explored in my last post, GeoParquet is an…*observablehq.com](https://observablehq.com/@kylebarron/geoarrow-and-geoparquet-in-deck-gl)

[**Prototyping GeoRust + GeoArrow in WebAssembly**
*Efficient, vectorized geospatial operations in the browser. Kyle Barron July 11, 2023 I'm excited about the browser as…*observablehq.com](https://observablehq.com/@kylebarron/prototyping-georust-geoarrow-in-webassembly)

There are also cool experiments like [Overture Maps Downloader](https://youssef-harby.github.io/OvertureMapsDownloader/), which uses DuckDB in Web Assembly to interact with Overture Map GeoParquet files up on [source.coop](https://source.coop). You can check out the [source code on github.](https://github.com/Youssef-Harby/OvertureMapsDownloader)
...
![](/assets/img/posts/the-geoparquet-ecosystem-at-1-0-0/1_yoKOgiVuDnUu4wiz1m_mlw.png)

The second producer to put data up as GeoParquet was Planet, converting the [RapidAI4EO STAC dataset](https://beta.source.coop/repositories/planet/rapidai4eo/description) into [GeoParquet](https://www.planet.com/data/stac/browser/external/radiantearth.blob.core.windows.net/mlhub/rapidai4eo/stac-v1.0/rapidai4eo_v1_source_pf/collection.json?.asset=asset-geoparquet-items), and Maxar also converted their [Open Data](https://www.maxar.com/open-data) [STAC](https://stacindex.org/catalogs/maxar-open-data-catalog-ard-format#/) to [GeoParquet](https://beta.source.coop/repositories/maxar/maxar-opendata/description).

![](/assets/img/posts/the-geoparquet-ecosystem-at-1-0-0/1__JPOCU1rJFnSNVXpSBnzBA.png)
...
![](/assets/img/posts/the-geoparquet-ecosystem-at-1-0-0/1_KvkQ2GUuM0Tr4-lzV92QYQ.png)
